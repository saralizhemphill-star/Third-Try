      ...
      <div className="min-h-screen bg-gray-50">
        ...
        <div className="max-w-4xl mx-auto px-4 py-8">
          ...
          <p className="text-gray-500 mb-6 flex items-center gap-4">
            ...
            <span className="flex items-center gap-1"><BookOpen size={14} /> Worksheet included</span>
          </p>
          <div className="bg-white rounded-xl border border-gray-200 p-6 mb-6">
            ...
            <ul className="space-y-2">
              {["Understand the core concept and why it matters", "Learn 2–3 specific techniques to try this week", "Identify patterns in your current approach", "Complete the reflection worksheet"].map((item, i) => (
